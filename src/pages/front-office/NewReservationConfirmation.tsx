    ...
    <main className="h-full w-full">
      ...
      <section className="w-full mt-8 flex flex-col justify-start p-4 gap-2">
        ...
        <p className="text-primary">
          <span className="font-bold">Attention</span> : vous avez choisi de
          pré-commander votre repas, assurez-vous donc que vous, et tous vos
          co-mangeurs aient commande leur plat avant{" "}
          <span className="font-bold">{timeofReservation}</span>. Sans quoi, le
          restaurateur pourra annuler votre commande.
        </p>
