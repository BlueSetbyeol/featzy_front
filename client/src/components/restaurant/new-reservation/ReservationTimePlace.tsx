...
const EMPTY_AVAILABILITIES: Availability[] = [];
...
export default function ReservationTimePlace({
  ...
  const availabilities = availabilityQuery.data ?? EMPTY_AVAILABILITIES;
  const loadingSlots = availabilityQuery.isFetching;

  // Garde le créneau sélectionné seulement s'il est toujours proposé après un
  // changement de date / nombre de couverts (ou un rafraîchissement des slots).
  useEffect(() => {
  ...
  }, [availabilities, setSelectedSlot]);
