...
import { useDietaryPreferences } from "@/hooks/useReference";
import { useUpdateDietaryPreferences } from "@/hooks/useAccount";
import { extractApiError } from "@/lib/axios";

export default function ProfileDietaryPreferences() {
  const { user } = useContext(UserContext);
  const { data: options = [], isLoading: loading } = useDietaryPreferences();
  const updatePreferences = useUpdateDietaryPreferences();
